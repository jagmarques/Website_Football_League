        ...
        <div id="firstbox">
            <nav>
                <ul>
                    ...
                    <li>
                        <a id="title2" href="Contests.php" style="background-color: green; color: white">CONTESTS</a>
                    </li>
                    <li>
        					...
        					if($sql!=NULL){
            					...
            					if($resultCheck>0){
                					while($row = mysqli_fetch_assoc($result)){
										echo '<nav id="contentTitle">' . $row['contest_name'] . '<button class="accordion">Info</button> <div class="panel"><p>Location: '. $row['location'] . '</p></div> </nav>';
									}
            					}
                                else{
